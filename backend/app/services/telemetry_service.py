...
class TelemetryService:
    ...
    async def save_feedback(
        ...
        try:
            ...
            print(f"✅ 用户反馈已保存: user_id={user_id}, rating={rating.overall_rating}")
            return True
    ...
    async def get_user_feedback(
        ...
        """
        try:
            return self.db.query(Telemetry)\
    ...
    async def cleanup_old_data(
        ...
        try:
            ...
            deleted_count = self.db.query(Telemetry)\
